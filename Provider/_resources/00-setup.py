...
dbName = "bdl_sharing_airlinedata"
...
catalog = "bdl_2023_delta_share_demo"
...
#   cleanup_catalog(catalog)
  ...
  spark.sql("DROP RECIPIENT IF EXISTS southwestairlines_databricks")
  spark.sql("DROP RECIPIENT IF EXISTS americanairlines_open_delta")
...
def init_data():
    ...
    if not table_exists("flights"):
        ...
        spark.sql(f"OPTIMIZE {dbName}.flights")
